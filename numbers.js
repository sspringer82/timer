export class Numbers {
  ...
  drawStandingShape(x, y) {
    ...
    this.ctx.lineTo(
      x + this.length,
      y + this.length * this.multiplier + this.length,
    );
  ...
  drawLyingShape(x, y) {
    ...
    this.ctx.lineTo(
      x + 2 * this.length + this.length * this.multiplier,
      y + this.length,
    );
    this.ctx.lineTo(
      x + this.length + this.length * this.multiplier,
      y + 2 * this.length,
    );
  ...
  drawNumber(number, x, y) {
    ...
    if (number.leftBottom) {
      this.drawStandingShape(
        x,
        y + 2 * this.length + this.length * this.multiplier + 3 * this.margin,
      );
    }
    ...
    if (number.middleMiddle) {
      this.drawLyingShape(
        x + this.length + this.margin,
        y + this.length + this.length * this.multiplier + 2 * this.margin,
      );
    }
    ...
    if (number.rightTop) {
      this.drawStandingShape(
        x + 2 * this.length + this.length * this.multiplier + 2 * this.margin,
        y + this.length + this.margin,
      );
    }
